    ...
    <div>
      <div className="justify-center text-center">
        ...
        <div>
          ...
          <ol className='px-20 md:px-32 lg:px-48 xl:px-56 text-justify font-medium text-sm sm:text-base md:text-lg lg:text-xl list-decimal list-outside'>
