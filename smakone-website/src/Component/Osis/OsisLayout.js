  ...
  return (
    <div>
        <div className='container mx-auto'>
            ...
            <div className='pt-12 md:px-14 lg:px-28 text-center xl:px-24 2xl:px-28'>
                <img src={ props.img } className="object-cover h-auto w-full md:rounded-3xl mt-6" alt={props.alt}/>
