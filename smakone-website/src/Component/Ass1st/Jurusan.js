        ...
        <div>
            <div className="container mx-auto mb-6">
                ...
                <div className='pt-8 md:px-16 xl:px-28'>
                    <img src={ props.img } className="object-cover w-screen h-auto md:w-full md:rounded-3xl mt-6" alt={props.alt}/>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 md grid-cols-1 gap-9 mt-4 place-items-center lg:mx-28 xl:mx-auto">
                <div>
