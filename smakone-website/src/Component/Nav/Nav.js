...
const Nav = (props) => {
    ...
    return (
        ...
        <div className={classNames(
            props.forceNavbar || props.carouselCurrentSlide > 0 || scrollPosition > 0 ? 'bg-slate-100 drop-shadow-[0_15px_12px_rgba(0,0,0,0.25)]' : 'lg:bg-inherit lg:drop-shadow-none bg-slate-100 drop-shadow-[0_15px_12px_rgba(0,0,0,0.25)]',
