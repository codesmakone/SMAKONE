...
const Alumni = (props) =>{
    return(
            <div className="container mx-auto flex flex-row lg:flex-col w-full h-auto mt-6 lg:mt-16 xl:mt-28">
                <img src={ props.img } className="object-cover rounded-2xl h-32 sm:h-40 md:h-44 lg:h-60 xl:h-80 2xl:h-92" alt={ props.title } />
