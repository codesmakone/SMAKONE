        ...
        <div>
            ...
            <div className='container mx-auto mt-28'>
                ...
                <div className='pt-12 px-6 md:px-12 lg:px-16 xl:px-28 text-justify'>
                    ...
                    <div className='text-lg my-6 px-3'>
                    Untuk info lebih lanjut mengenai kegiatan pramuka dan dewan ambalan dapat mengunjungi instagram <a href='https://www.instagram.com/dasmukie/' target="blank" className='font-semibold text-blue-600'>@dasmukie</a> atau menghubungi dewan ambalan dan pembina.
                    </div>
                    </div>
