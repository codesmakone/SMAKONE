      ...
      <div className="py-20 px-12">
          <div className="bg-cover bg-footer-image rounded-xl py-24">
              <div className="flex flex-col items-center">
                ...
                <div>
                    <a href="https://www.instagram.com/smukiee/" target="blank" className="text-xl md:text-2xl xl:text-3xl text-white font-bold  rounded-full bg-light-blue py-2 md:py-4 xl:py-6 px-6 md:px-10 xl:px-16 flex justify-center hover:bg-blue-700">
                      @smukiee
                    </a>
                </div>
              </div>
