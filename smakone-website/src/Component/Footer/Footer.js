        ...
        <div className="mx-auto">
          ...
          <div>
            ...
            <div>
              <div className=" flex justify-center gap-3 md:justify-around px-8 md:mx-10 md:pb-12">
                <div className="flex flex-col gap-y-2 xl:gap-y-4 text-gray-500 md:font-bold text-[0.9rem] sm:text-lg xl:text-xl">
                  <Link to="/OSIS" className="hover:text-gray-500 font-bold text-black">
                    Tentang OSIS
                  </Link>
                ...
                <div className="flex flex-col text-[0.9rem] sm:text-lg xl:text-xl gap-y-2 xl:gap-y-4 text-gray-500 md:font-bold">
                  <Link to="/Kehidupan_smukiers" className="hover:text-gray-500 font-bold text-black">
                    Kehidupan SMUKIERS
                  </Link>
                  <Link to="/Kehidupan_smukiers/Tips" className="hover:text-black">
                    Tips Belajar
                  </Link>
                  <Link to="/Kehidupan_smukiers/Kegiatan" className="hover:text-black">
                    Kegiatan
                  </Link>
                  <Link to="/Kehidupan_smukiers/Alumni" className="hover:text-black">
                    Alumni
                  </Link>
                </div>
                ...
                <div className="hidden md:inline">
                  ...
                  <div className="md:flex md:flex-row md:gap-x-1">
                    <a href="mailto:smak1.osis@bpkpenaburjakarta.or.id" className="mt-[0.1em]">
                      <ImMail2 size={27} />
                    </a>
                    <a href="https://www.instagram.com/smukiee/" target="blank">
                      <FaInstagramSquare size={30} />
                    </a>
                    <a href="https://www.tiktok.com/@smukierz" target="blank" className="mt-[0.1em]">
                      <FaTiktok size={27} />
                    </a>
            ...
            <div className="bg-gray-100 text-center py-1 text-xs">
              <p>Copyright © 2024 SMAK ONE Student Council All Rights Reserved</p>
            </div>
          </div>
        </div>
      </footer>
