...
import Team from "../../../Image/Clubs/Cressendo/cressendo1.webp";
import Logo from "../../../Image/Clubs/Cressendo/logo.webp";
  ...
  return (
    <main className="relative mt-12 md:mt-16 lg:mt-20">
      <header className="relative">
        ...
        <img
          className="absolute top-[7rem] md:top-[10.5rem] xl:top-[9rem] left-[50%] -translate-x-[50%] z-2 w-[18rem] sm:w-[28rem] md:w-[36rem] xl:w-[50rem]"
          src={Logo}
          alt="Cressendo Logo"
        />
        <Section />
