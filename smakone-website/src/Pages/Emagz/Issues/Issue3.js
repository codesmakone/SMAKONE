...
const Issue3 = () => {
    return(
        <EmagzLayout button={true} feat={false} title="Square One" iframe={(
            <div>
                ...
                <p className="justify-center text-center p-2 text-2xl">
                    ...
                    <a className="text-blue-500 underline-offset-4" href="https://heyzine.com/flip-book/6b4815b101.html" target="blank"> link</a>.
                </p>
                </div>
            </div>
            )} />
