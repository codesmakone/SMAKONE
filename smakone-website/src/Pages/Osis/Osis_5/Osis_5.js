      ...
      <OsisTeam
        ...
        person2={
          <BidangSection
            img={Felisitas}
            alt="Felisitas"
            name="Felisitas Fiona Fanza"
            desc="Halo semua, salkenn! Aku Felisitas Fiona Fanza biasa dipanggil Fifi/Feli, whichever you prefer :D 
        ...
        person1={
          <BidangSection
            ...
            alt="Metta"
            name="Metta Nimmala"
            desc="haii all!! salkenn nama aku metta nimmala, biasanyaa dipanggil metta. aku suka bangett cooking, baking 👩‍🍳🍳 anddd nonton series🥤. soo kalo kalian ada rekomendasi movies, series, books, games yang baguss, recipes, or anything else, feel free to reach me out @mettanimmala 😉🙌 goodluckk and have funn!!!"
          />
        }
        Description={true}
