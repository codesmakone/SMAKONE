  ...
  return (
    <div>
      <OsisTeam
        ...
        Description={true}
        DescBid="Bidang 9,  Bidang Pembinaan Teknologi Informasi dan Komunikasi (TIK) adalah bidang yang bertanggung jawab mengenai pemanfaatan TIK untuk melancarkan kegiatan-kegiatan ataupun acara di sekolah, seperti menjadi tim multimedia saat ada seminar. Selain itu, Bidang 9 juga memanfaatkan TIK sebagai sarana penyebaran informasi agar siswa-siswi dapat mengenal OSIS SMAK 1 secara lebih luas dan mendalam melalui pengelolaan Website OSIS dan SMAK One Social Network sebagai media informasi dan interaksi digital. Bidang 9 turut mendukung pengembangan talenta siswa-siswi SMAK 1 melalui berbagai wadah kreatif dan teknologi, seperti Shutterone dalam bidang dokumentasi dan video editing, Monograph dalam desain grafis, CodeOne dalam pengembangan web dan kebutuhan programming OSIS, OneJournal dalam penulisan artikel serta produksi majalah digital, serta KRIZA e-Sports sebagai tim e-sports sekolah. Selain itu, Bidang 9 juga mengelola berbagai fitur digital sekolah seperti Arch1ve sebagai pusat arsip dokumentasi kegiatan, Smukie’s Calendar sebagai kalender kegiatan bulanan, dan Smukie 360° sebagai virtual tour interaktif lingkungan SMAK 1."
        Program={true}
        ProgramList={[
          //PENDING
