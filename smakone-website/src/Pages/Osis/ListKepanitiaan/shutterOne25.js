    ...
    <div>
      ...
      <div className="mt-28 mx-auto">
        <h1 className="text-center text-4xl sm:text-4xl md:text-5xl xl:text-5xl font-black mb-20">
          Hasil Seleksi Tahap 1 ShutterOne 2025
        </h1>
        <div className="flex flex-col items-center">
          <p className="text-left w-3/4 ">
            Setelah kami melakukan seleksi selama 9 hari pada,{" "}
            <b> Jumat 3 Oktober - Sabtu 11 Oktober 2025</b>, telah ditentukan
            yang lolos tahap 1 sebagai berikut:
          </p>
        </div>
        <SeleksiGrid
          title=""
      ...
      <section className="max-w-3xl mx-auto py-10 font-serif leading-relaxed">
        {/* Date */}
        <p className="text-right px-10">Jakarta, 12 Oktober 2025</p>
