  ...
  return (
    <div>
      <OsisTeam
        ...
        Description={true}
        DescBid="Bidang 4 atau Bidang Pembinaan Prestasi Akademik dan Ilmu Pengetahuan dan Teknologi (IPTEK) adalah bidang yang bertanggungjawab dan berkolaborasi dengan sekolah dalam mendukung perkembangan prestasi siswa dan pemanfaatan IPTEK dalam proses belajar. Bidang 4 merupakan bidang yang menyediakan wadah bagi siswa-siswi untuk mencari dan mengembangkan ilmu di luar jam belajar, bidang 4 menyediakan berbagai cara untuk siswa-siswi dapat mengembangkan ilmu dan skill masing-masing mulai dari event seperti TedxYouth@SmakOne yang bertujuan untuk mengembangkan soft skills siswa-siswi dimana siswa-siswi berkesempatan untuk menyampaikan ide-ide baru yang akan diperdengarkan kepada masyarakat luas. Ada juga program-program seperti UniAssist yang bertujuan untuk membantu siswa-siswi dalam memilih kuliahnya setelah lulus, Encycloped1a yang bertujuan agar siswa-siswi dapat mengetahui lebih banyak informasi baru di dunia kita, dan FSL (Facts, Science, Life) program yang menunjukkan aplikasi ilmu terhadap kehidupan kita sehar-hari."
        Program={true}
        ProgramList={[
          //UPDATED 2026
