    ...
    <div>
      ...
      <div id='osis' className='mx-auto container mt-28'>
        <OsisLayout
          ...
          img={Osis_Image}
          visi1="Menjadikan OSIS SMAK 1 PENABUR Jakarta sebagai wadah untuk menampung aspirasi, potensi, dan kreativitas siswa serta membentuk kepribadian siswa yang beriman, berkarakter, dan berprestasi unggul secara akademik maupun non-akademik."

          misi1="Mengembangkan minat, bakat, dan potensi siswa melalui penyelenggaraan program kerja OSIS yang inovatif dan bermutu."
          misi2="Mendorong partisipasi aktif siswa dalam berprestasi secara akademik maupun non-akademik."
          misi3="Menumbuhkan rasa kekeluargaan dan solidaritas antar warga SMAK 1 PENABUR Jakarta untuk menciptakan lingkungan yang sehat dan positif."
        />
      </div>
