  ...
  return (
    <div>
      <OsisTeam
        ...
        person4={<BidangSection img={Glenardy} alt='Glenardy' name='Glenardy Joseph Guantoro' desc='Haloo semua kenalin nama aku Glenardy tapi panggil aja aku Glen. Tahun ini aku berada di kelas X-9. Hobi aku ada banyak tapi yang paling aku sering lakuin itu olahraga, makanya aku daftar bidang 7. Funfact tentang aku, aku suka bgt tidur. Kalo kalian ada mau tanya apa" atau mau ngobrol bisa langsung aja ke ig aku @glenardy.joseph, salam kenal semuaa!!'/>}
        Description={true}
