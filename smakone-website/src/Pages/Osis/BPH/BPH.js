  ...
  return (
    <div>
      <OsisTeam
        ...
        person5={<BidangSection img={Jessica} alt='Jessica' name='Jessica Regina Aliudin' desc="hi semuaa! perkenalkan namaku jessica, biasa dipanggil jess <3 tahun ini, aku diberi kesempatan untuk menjabat sebagai Bendahara OSIS ☆☆ so happy and grateful for this chance !! hobby aku tuhh ngedit video, main game, stan k-pop, debat andd.. nonton anime hehe. about editing: i'm FULLY team after effects and anti capcut bangett (kecuali kalau bikin tiktok jamet HAHAHA). fun fact nickname aku tuh 'wibu nolep', wibu karena nonton anime and nolep karena masih kumon ♡ i'm always open to convos and chats, so feel free to dm me @jessica.aliudin, have fun in smukie!! <3"/>}
        dirBPH= "/OSIS/bidang1"
      />
    </div>
  )
