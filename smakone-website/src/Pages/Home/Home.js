    ...
    <div className=''>
      ...
      <div className='col-span-6 flex flex-col justify-start text-left '>
        <div className='px-20 pt-20 pb-32'>
          ...
          <div className="gap-5">
          <h1 className="text-[3.5rem] font-black leading-tight">ALL NEW 10<sup>th</sup> GRADERS</h1>
          <div className="mt-10">
          <a href="drive.com" target="blank" className="text-white bg-black font-bold rounded-full text-2xl px-12 py-5 text-center mr-2 mb-2">
            CLICK HERE
          </a>
          </div>
          </div>
